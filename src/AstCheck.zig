...
pub fn generate(gpa: Allocator, tree: Ast, change_pending: *std.atomic.Value(bool)) Allocator.Error!Zir {
    ...
    // TODO First reasonable opportunity to return is here, but
    // need valid slices for .string_bytes and .extra
    // => return error.Cancelled and modify fns up the call stack
